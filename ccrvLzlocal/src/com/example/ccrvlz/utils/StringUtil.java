 ...
 * @Description: 字符串工具类
 * @author lyj
 * @version V1.0, 2014年9月23日 上午10:43:07
 * @see 
 * @since 
 */
public class StringUtil {
	...
	/**
	 * 从知道字符串中移除末尾的字符，不存在则返回原字符串
	 * @param str
	 * @param lastStr
	 * @return
	 */
	public static String trimLast(String str,String lastStr) {
	 ...
	 * @return
	 */
	public String convertEncode(String str, String fEncode, String tEncode) {
		if (str == null) {
			return str;
		} else {
			try {
