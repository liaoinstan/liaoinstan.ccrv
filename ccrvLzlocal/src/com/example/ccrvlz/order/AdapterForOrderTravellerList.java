...
public class AdapterForOrderTravellerList extends BaseAdapter{
	private Context context = null;
	private int src;
	//data
	private List<OrderTraveller> results;
	public List<OrderTraveller> getResults() {
		return results;
	}
	
    LayoutInflater inflater;  
    
    AdapterForOrderTravellerList(Context context,BitmapUtils bitmapUtils,int src,List<OrderTraveller> results){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		hoder1.text_order_ges_list_item_num.setText(results.get(position).getIdCard());
