...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    titleTextColor = a.getColor(R.styleable.CalendarPickerView_titleTextColor,
        res.getColor(R.color.calendar_month_title_text));
    displayHeader = a.getBoolean(R.styleable.CalendarPickerView_displayHeader, false);	//mark by lz 这里表明 默认显示不星期头
...
//    }
    int expandSpec = MeasureSpec.makeMeasureSpec(Integer.MAX_VALUE >> 2, MeasureSpec.AT_MOST);	//自适应高度
